...
import { tableColumnsReceipt } from 'variables/ecommerce/order-details/tableColumnsReceipt';
import tableDataReceipt from 'variables/ecommerce/order-details/tableDataReceipt.json';
